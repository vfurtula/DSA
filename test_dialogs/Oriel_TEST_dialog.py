...
from instruments import Oriel_stepper
	...
	def runstop(self):
		...
		if sender.text()=="Set position target":
			...
			if self.target=="A":
				...
				QMessageBox.warning(self, 'Message',"The target position is specified. Choose A or B in the set position targen field.")
