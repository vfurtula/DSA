...
import traceback, sys, os, sqlite3, itertools, collections, configparser, getpass
...
import MS257, K2001A, Scan_Worker
...
class Run_gui(QMainWindow):
	...
	def send_notif(self):
		...
		self.md1 = Indicator_dialog.Indicator_dialog(self, "...sending files...", "indicators/ajax-loader-ball.gif")
