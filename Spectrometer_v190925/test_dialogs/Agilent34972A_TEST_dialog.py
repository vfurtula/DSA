...
from instruments import Agilent34972A
...
class Agilent34972A_TEST_dialog(QDialog):
	...
	def set_run(self):
		...
		try:
			self.Agilent34972A = Agilent34972A.Agilent34972A(str(self.serialportEdit.text()), False)
			...
			if reply == QMessageBox.Yes:
				self.Agilent34972A = Agilent34972A.Agilent34972A(str(self.serialportEdit.text()), True)
			else:
				return
