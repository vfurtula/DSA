...
from test_dialogs import MS257_TEST_dialog, K2001A_TEST_dialog, Oriel_TEST_dialog, A34972A_TEST_dialog, GUV_TEST_dialog
...
class Run_gui(QMainWindow):
	...
	def initUI(self):
		...
		self.c_k2001a_all_Aon = self.p1.plot(pen=None, symbol='s', symbolPen='g', symbolBrush='g', symbolSize=3)
		self.c_k2001a_all_Aoff = self.p1.plot(pen=None, symbol='s', symbolPen='r', symbolBrush='r', symbolSize=3)
		self.c_k2001a_all_Bon = self.p1.plot(pen=None, symbol='p', symbolPen='g', symbolBrush='g', symbolSize=3)
		self.c_k2001a_all_Boff = self.p1.plot(pen=None, symbol='p', symbolPen='r', symbolBrush='r', symbolSize=3)
		
		self.c_a34972a_all_Aon = self.p1.plot(pen=None, symbol='d', symbolPen='g', symbolBrush='g', symbolSize=3)
		self.c_a34972a_all_Aoff = self.p1.plot(pen=None, symbol='d', symbolPen='r', symbolBrush='r', symbolSize=3)
		self.c_a34972a_all_Bon = self.p1.plot(pen=None, symbol='o', symbolPen='g', symbolBrush='g', symbolSize=3)
		self.c_a34972a_all_Boff = self.p1.plot(pen=None, symbol='o', symbolPen='r', symbolBrush='r', symbolSize=3)
		...
		print("Multithreading in RUN_gui with maximum %d threads" % self.threadpool.maxThreadCount())
	...
	def instrumentsDialog(self):
		...
		if self.inst_list.get('Oriel'):
			...
			if self.posset=="A":
				self.combo6.setEnabled(True)
				self.combo7.setEnabled(False)
				if self.inst_list.get('GUV') or self.inst_list.get('K2001A') or self.inst_list.get('A34972A'):
					self.combo8.setEnabled(True)
					self.combo10.setEnabled(False)
			elif self.posset=="B":
				self.combo6.setEnabled(False)
	...
	def testA34972ADialog(self):
		...
		self.A34972A_TEST_dialog = A34972A_TEST_dialog.A34972A_TEST_dialog(self)
		self.A34972A_TEST_dialog.exec()
	...
	def prepare_file(self):
		...
		if self.inst_list.get('K2001A') or self.inst_list.get('A34972A') or self.inst_list.get('GUV'):
	...
	def set_run(self):
		...
		for i in range(len(self.guv_channels)):
			...
			self.c_guv_all_Aon.append(self.p1.plot(pen=None, symbol='s', symbolPen='g', symbolBrush='g', symbolSize=7 ))
			mycol=next(colors)
			...
			self.c_guv_all_Bon.append(self.p1.plot(pen=None, symbol='p', symbolPen='g', symbolBrush='g', symbolSize=7 ))
			mycol=next(colors)
			...
			self.c_guv_all_Aoff.append(self.p1.plot(pen=None, symbol='d', symbolPen='r', symbolBrush='r', symbolSize=7 ))
			mycol=next(colors)
			...
			self.c_guv_all_Boff.append(self.p1.plot(pen=None, symbol='o', symbolPen='r', symbolBrush='r', symbolSize=7 ))
