...
class Instruments_dialog(QDialog):
	...
	def __init__(self, parent, inst_list, timer):
		...
		try:
			...
			self.k2001apos_str=self.config.get('DEFAULT','k2001aport').strip().split(',')[1]
			self.k2001aport_check=self.bool_(self.config.get('DEFAULT','k2001aport').strip().split(',')[2])
			self.a34972aport_str=self.config.get('DEFAULT','a34972aport').strip().split(',')[0]
			self.a34972apos_str=self.config.get('DEFAULT','a34972aport').strip().split(',')[1]
			self.a34972aport_check=self.bool_(self.config.get('DEFAULT','a34972aport').strip().split(',')[2])
			...
			self.guvtype_str=self.config.get('DEFAULT','guvtype').strip().split(',')[0]
			self.guvpos_str=self.config.get('DEFAULT','guvtype').strip().split(',')[1]
	...
	def initUI(self):
		...
		################################
		self.k2001a_cb = QComboBox(self)
		k2001apos_lbl = QLabel("Position",self)
		k2001apos_lbl.setStyleSheet("color: blue")
		mylist_pos=["A","B","None"]
		self.k2001a_cb.addItems(mylist_pos)
		self.k2001a_cb.setCurrentIndex(mylist_pos.index(self.k2001apos_str))
		self.k2001a_cb.setEnabled(self.k2001aport_check)
		self.k2001a_cb.setFixedWidth(65)
		...
		################################
		self.a34972a_cb = QComboBox(self)
		a34972apos_lbl = QLabel("Position",self)
		a34972apos_lbl.setStyleSheet("color: blue")
		self.a34972a_cb.addItems(mylist_pos)
		self.a34972a_cb.setCurrentIndex(mylist_pos.index(self.a34972apos_str))
		self.a34972a_cb.setEnabled(self.a34972aport_check)
		self.a34972a_cb.setFixedWidth(65)
		...
		################################
		self.guvpos_cb = QComboBox(self)
		guvpos_lbl = QLabel("Position",self)
		guvpos_lbl.setStyleSheet("color: blue")
		self.guvpos_cb.addItems(mylist_pos)
		self.guvpos_cb.setCurrentIndex(mylist_pos.index(self.guvpos_str))
		self.guvpos_cb.setEnabled(self.guvport_check)
		self.guvpos_cb.setFixedWidth(65)
		################################
		...
		g0_0.addWidget(self.cb_ims257,0,4)
		...
		g0_0.addWidget(self.cb_oms257,4,4)
		...
		g0_0.addWidget(self.cb_oriel,8,4)
		...
		g0_0.addWidget(k2001apos_lbl,12,1)
		g0_0.addWidget(self.cb_k2001a,12,4)
		g0_0.addWidget(self.k2001aEdit,13,0)
		g0_0.addWidget(self.k2001a_cb,13,1)
		g0_0.addWidget(self.k2001a_status,14,0)
		g0_0.addWidget(empty_string,15,0)
		
		g0_0.addWidget(a34972a_lbl,16,0)
		g0_0.addWidget(a34972apos_lbl,16,1)
		g0_0.addWidget(self.cb_a34972a,16,4)
		g0_0.addWidget(self.a34972aEdit,17,0)
		g0_0.addWidget(self.a34972a_cb,17,1)
		g0_0.addWidget(self.a34972a_status,18,0)
		g0_0.addWidget(empty_string,19,0)
		
		h0_1 = QHBoxLayout()
		h0_1.addWidget(guvip_lbl)
		h0_1.addWidget(guvport_lbl)
		h0_1.addWidget(guvtype_lbl)
		h0_2 = QHBoxLayout()
		h0_2.addWidget(self.guvipEdit)
		h0_2.addWidget(self.guvportEdit)
		h0_2.addWidget(self.guvtype_cb)
		
		g0_0.addLayout(h0_1,20,0)
		g0_0.addWidget(guvpos_lbl,20,1)
		g0_0.addWidget(self.cb_guv,20,4)
		g0_0.addLayout(h0_2,21,0)
		g0_0.addWidget(self.guvpos_cb,21,1)
		g0_0.addWidget(self.guv_status,22,0)
		g0_0.addWidget(empty_string,23,0)
		
		g0_0.addWidget(testmode_lbl,24,0)
		g0_0.addWidget(self.cb_testmode,24,4)
    ...
    ##############################################
		...
		self.k2001a_cb.activated[str].connect(self.onActivatedK2001Apos)
		self.cb_k2001a.stateChanged.connect(self.k2001a_stch)
		
		self.a34972a_cb.activated[str].connect(self.onActivatedA34972Apos)
		...
		self.guvpos_cb.activated[str].connect(self.onActivatedGUVpos)
	...
	def onActivatedA34972Apos(self, text):
		
		if str(text)!=self.a34972apos_str:
			self.on_text_changed()
			
		self.a34972apos_str = str(text)
		
	def onActivatedK2001Apos(self, text):
		
		if str(text)!=self.k2001apos_str:
			self.on_text_changed()
			
		self.k2001apos_str = str(text)
		
	def onActivatedGUVpos(self, text):
		
		if str(text)!=self.guvpos_str:
			self.on_text_changed()
			
		self.guvpos_str = str(text)
	...
	def k2001a_stch(self, state):
		...
		if state in [Qt.Checked,True]:
			...
			self.k2001a_cb.setEnabled(True)
		else:
			self.k2001aEdit.setEnabled(False)
			self.k2001a_cb.setEnabled(False)
	...
	def a34972a_stch(self, state):
		...
		if state in [Qt.Checked,True]:
			...
			self.a34972a_cb.setEnabled(True)
		else:
			self.a34972aEdit.setEnabled(False)
			self.a34972a_cb.setEnabled(False)
	...
	def set_connect(self):
		...
		if self.cb_testmode.isChecked():
			...
			if self.cb_guv.isChecked():
				self.GUV = GUV.GUV([self.guvip_str,self.guvport_str,self.guvtype_str],True,None)
			...
			if self.cb_guv.isChecked():
				try:
					self.GUV = GUV.GUV([self.guvip_str,self.guvport_str,self.guvtype_str],False,None)
	...
	def save_(self):
		...
		self.config.set('DEFAULT', 'k2001aport', ','.join([str(self.k2001aEdit.text()),self.k2001apos_str, str(self.cb_k2001a.isChecked())]) )
		self.config.set('DEFAULT', 'a34972aport', ','.join([str(self.a34972aEdit.text()),self.a34972apos_str, str(self.cb_a34972a.isChecked())]) )
		...
		self.config.set('DEFAULT', 'guvtype', ','.join([self.guvtype_str,self.guvpos_str]) )
