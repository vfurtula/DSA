...
class Run_TEST(QMainWindow):
	...
	def initUI(self):
		...
		mylist12=["100","200","400","600","800","1000","1500","2000"]
		self.combo12.addItems(mylist12)
		self.combo12.setCurrentIndex(mylist12.index( str(self.schroll_pts) ))
	...
	def load_(self):
		...
		try:
			...
			self.posAB_delay = float(self.config.get('DEFAULT','posAB_delay'))
			...
			self.avgpts_a = int(self.config.get('DEFAULT','avgpts_a'))
			self.avgpts_b = int(self.config.get('DEFAULT','avgpts_b'))
	...
	def save_(self):
		...
		self.config.set('DEFAULT','schroll', str(self.schroll_pts) )
		self.config.set('DEFAULT','pos', ','.join([self.posset, self.posnow]) )
		self.config.set('DEFAULT','posA_delay', str(self.posA_delay) )
		self.config.set('DEFAULT','posB_delay', str(self.posB_delay) )
		self.config.set('DEFAULT','posAB_delay', str(self.posAB_delay) )
		self.config.set('DEFAULT','shutter', ','.join([self.shutset, self.shutnow]) )
		self.config.set('DEFAULT','avgpts_a', str(self.avgpts_a) )
		self.config.set('DEFAULT','avgpts_b', str(self.avgpts_b) )
