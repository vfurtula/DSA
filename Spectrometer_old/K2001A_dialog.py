...
class K2001A_dialog(QDialog):
	...
	def setupUi(self):
		...
		print("Multithreading in K2001A_dialog with maximum %d threads" % self.threadpool.maxThreadCount())
	...
	def set_run(self):
		...
		try:
			...
			QMessageBox.warning(self, 'Message',"No response from the K2001A GPIB port! Check the GPIB port name and the cable connection.")
			return
