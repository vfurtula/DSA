...
class Write2file_dialog(QDialog):
	...
	def save_(self):
		...
		self.config.set('DEFAULT', 'write2txt', ','.join([str(self.w2txtFileEdit.text()), str(self.cb_w2txt.isChecked()) ]) )
		self.config.set('DEFAULT', 'write2db', ','.join([str(self.w2dbFileEdit.text()), str(self.cb_w2db.isChecked())]) )
		self.config.set('DEFAULT', 'write2mat', ','.join([str(self.w2matFileEdit.text()), str(self.cb_w2mat.isChecked()) ]) )
