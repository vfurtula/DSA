...
import os, re, imp, serial, time, yagmail, zipfile, configparser, getpass
...
class Send_Worker(QRunnable):
	...
	def run(self):
		...
		try:
			yag = yagmail.SMTP(self.emailset_str[0], getpass.getpass( prompt=''.join(["Password for ",self.emailset_str[0],"@gmail.com:"]) ))
